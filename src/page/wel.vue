      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="total-frame">
            <i class="font_family mall-order total-icon">
            </i>
        ...
        <el-col :span="6">
          <div class="total-frame ">
            <i class="font_family mall-total-today total-icon">
            </i>
        ...
        <el-col :span="6">
          <div class="total-frame">
            <i class="font_family mall-total-yesterday total-icon">
            </i>
        ...
        <el-col :span="6">
          <div class="total-frame">
            <i class="font_family mall-total-week total-icon">
            </i>
...
<style scoped>
  ...
  /*重写http://at.alicdn.com/t/font_1023789_prevxv5j9j8.css ：16px 改为32px*/
  .font_family {
